          ...
          {STATS.map(
            ({
              ...
              >
                {/* Top accent bar */}
                <div
                  className={`absolute top-0 left-1/2 -translate-x-1/2 w-16 h-0.5 ${topBar} rounded-b-full`}
                />

                {/* Icon */}
                <div
                  className={`w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-5 ${iconWrap}`}
                >
