...
export default function MapSection() {
  return (
    <section className="py-16 md:py-24 px-6 bg-slate-50/50 dark:bg-white/[0.02] backdrop-blur-sm border-t border-slate-200 dark:border-white/[0.05] overflow-hidden relative">
      {/* Background glow */}
